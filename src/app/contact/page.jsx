      ...
      <div className="max-w-screen-xl px-4 pt-16 mx-auto lg:pt-32">
        <div className="text-center mb-10">
          <h1 className="lg:text-4xl font-semibold uppercase border-b-2 pb-1">
            contact <span className="text-[#04D1E0]">Me</span>
          </h1>
        </div>
        <div className="px-4 md:px-20 mb-10">
          <form action="#" className="space-y-8">
            ...
            <button
              type="submit"
              className="w-full px-6 py-2 text-xl uppercase text-[#04D1E0] border border-[#04D1E0] tracking-[3px] hover:text-[#022C43] hover:bg-[#04D1E0] mt-8"
            >
              Send message
            </button>
          </form>
